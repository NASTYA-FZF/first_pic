...
// first_pic.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CfirstpicApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CfirstpicApp

CfirstpicApp::CfirstpicApp()
{
...
// Единственный объект CfirstpicApp

CfirstpicApp theApp;


// Инициализация CfirstpicApp

BOOL CfirstpicApp::InitInstance()
{
